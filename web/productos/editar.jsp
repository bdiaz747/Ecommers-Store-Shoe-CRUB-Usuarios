...
<body class="bg-gray-100">
    ...
    <%
        // Producto enviado desde el servlet
    ...
    <div class="max-w-4xl mx-auto mt-10 bg-white p-8 rounded shadow">
        ...
        <form action="ProductoServlet" method="POST" enctype="multipart/form-data">
            ...
            <select name="id_categoria" class="w-full border p-2 mb-4" required>
                ...
                %>
                    <option value="<%= c.getIdCategoria() %>"
                        <%= (c.getIdCategoria() == producto.getIdCategoria()) ? "selected" : "" %>>
            ...
            <input type="text" name="marca_producto"
                   value="<%= producto.getMarcaProducto() %>"
                   class="w-full border p-2 mb-4" required>

            <!-- DESCRIPCIÓN -->
            <label class="block mb-2 font-semibold">Descripción</label>
            <textarea name="descripcion_producto"
                      class="w-full border p-2 mb-4" required><%= producto.getDescripcionProducto() %></textarea>
            ...
            <input type="number" name="stock_producto"
                   value="<%= producto.getStockProducto() %>"
                   class="w-full border p-2 mb-4" required>
